...
const MockTalk = (
  <MockFrame label="トーク画面">
    ...
    <p style={{ fontSize: '0.6875rem', color: 'var(--color-text-tertiary)', marginTop: '0.75rem', paddingTop: '0.625rem', borderTop: '1px solid var(--color-border)', lineHeight: 1.6 }}>
      ※ 団体のメンバーなら誰でも、このトークに参加したり、メンバー（当日の担当者など）を追加したりできます<br />
...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    detail: <>やり取りはアプリ内のトークで行います。承認した人と団体長が最初から参加し、<b>団体のメンバーなら誰でも</b>あとから参加したり、当日の担当者を加えたりできます。終わったら完了報告をして、<b>お互いに感謝の言葉</b>を送れます。</>,
    action: '完了報告する',
    mock: MockTalk,
  },
  {
